let chatMessages = [
    { sender: 'User1', receiver: 'User2', message: 'Hello, how are you?' },
    { sender: 'User2', receiver: 'User1', message: 'I\'m fine, thank you!' },
    { sender: 'User1', receiver: 'User2', message: 'That\'s great to hear!' }
  ];
  
  // Dummy user list data (replace with actual data)
  const userListData = ['User1', 'User2', 'User3'];
  ...
  function sendMessage() {
    ...
    if (message !== '') {
      ...
      chatMessages.push({ sender: 'User1', receiver: currentChatUser, message: message });
      console.log
  ...
  // Display initial chat users and start chat with the first user
  displayChatUsers();
  startChatWithUser(userListData[0]); // Start chat with the first user by default
